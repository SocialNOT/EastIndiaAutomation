  ...
  return (
    <section id="cta" className="w-full py-20 md:py-32 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        <h2 className="font-headline text-4xl sm:text-5xl md:text-6xl !leading-tight">
          Ready to Automate Your Global Enterprise?
        </h2>
        <p className="mt-4 mb-8 text-base md:text-lg text-muted-foreground max-w-2xl mx-auto">
        ...
        <Button 
          size="lg" 
          className="font-bold tracking-wider text-base md:text-xl w-full max-w-lg h-auto py-5 md:py-6 transition-all duration-300 hover:shadow-[0_0_20px_hsl(var(--primary))]"
